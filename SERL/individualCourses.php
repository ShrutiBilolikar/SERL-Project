...
$CID = $_GET['CID'];
$sql="SELECT count(*) FROM researcherCourses WHERE CID='$CID'";
$sql2="SELECT researcherID FROM researcherCourses WHERE CID='$CID'";
...
//         $RID=$row2['researcherID'];
//         $qq = "SELECT count(*) FROM researcher WHERE researcherID='$RID'";
//         $q1 = "SELECT * FROM researcher WHERE researcherID='$RID'";
                ...
                <!-- <div class="card mb-5 mb-xl-3"> -->
                    <div class="card-body p-5">
                        <div class="mb-3" style="background:#f7bfbf;">
                            <!-- <span class="display-6 fw-bold"><?php echo $row4['name'];?></span> -->
                            <div class="photo"><?php echo "<img src='".$row4['img_source']."' width= '50%'>" ;?></div>
                            <p class="text-muted"><?php echo $row4['name'];?><br><?php echo $row4['department'];?><br><?php echo "IIIT Allahabad";?></p>
                        ...
                        <ul class="list-unstyled mb-4" style="background:#b8f2ef">
                            ...
                            <li class="mb-2">
                            <b><?php echo "Mobile: "?></b>
                            <?php echo $row4['mobile'];?>
                            <li>
                            <li>
                                <?php
                                $var=$row4['researcherID'];
